...
import 'package:locategeouser/screens/training/video_info.dart';
import 'package:locategeouser/ui/theme.dart' as color;
...
class _HomeScreenState extends State<trainingHomeScreen> {
  List info = [];
  _initData() {
